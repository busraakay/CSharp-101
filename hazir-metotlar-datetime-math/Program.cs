...
namespace hazir_metotlar_datetime_math
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(DateTime.Now.ToString("yyyy"));//2222

            Console.WriteLine("**** Math Kütüphanesi *****");//2222
            //Math Kütüphanesi
            ...
            Console.WriteLine(Math.Exp(3));// e üzeri değeri getirir.
            Console.WriteLine(Math.Log10(10));//log 10 tabanındaki değer
